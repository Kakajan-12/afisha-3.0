...
function ssc_directionCheck(e, t) {
  (e = e > 0 ? 1 : -1),
    (t = t > 0 ? 1 : -1),
    (ssc_direction.x !== e || ssc_direction.y !== t) &&
      ((ssc_direction.x = e), (ssc_direction.y = t), (ssc_que = []));
}
  ...
  ((function (e, t) {
    ...
    function v(e, t) {
      for (var n, i, o = [], r = 0, s = e.length; r < s; r++)
        (i = e[r]).style &&
          ...
          t
            ? ("none" === n &&
                ((o[r] = $e.get(i, "display") || null),
                o[r] || (i.style.display = "")),
              "" === i.style.display && We(i) && (o[r] = m(i)))
            : "none" !== n && ((o[r] = "none"), $e.set(i, "display", n)));
    ...
    function w(e, t, n, i, o) {
      ...
      for (d.textContent = "", h = 0; (r = f[h++]); )
        if (i && pe.inArray(r, i) > -1) o && o.push(r);
          ...
          ((c = pe.contains(r.ownerDocument, r)),
    ...
    function A(e, t) {
      ...
      if (1 === t.nodeType) {
        if (
          $e.hasData(e) &&
          ((r = $e.access(e)), (s = $e.set(t, r)), (c = r.events))
        ) {
        ...
        He.hasData(e) &&
          ((a = He.access(e)), (l = pe.extend({}, a)), He.set(t, l));
      }
    }
    function D(e, t) {
    ...
    function O(e, t, i, o) {
      ...
      if (
        ...
        if (l)
          for (
            u = a[a.length - 1].ownerDocument, pe.map(a, x), d = 0;
            d < l;
            d++
          )
            (c = a[d]),
    ...
    function P(e, t, n, i, o) {
      ...
      for (
        ...
        "margin" === n && (s += pe.css(e, n + Re[r], !0, o)),
          i
            ? ("content" === n && (s -= pe.css(e, "padding" + Re[r], !0, o)),
              "margin" !== n &&
                (s -= pe.css(e, "border" + Re[r] + "Width", !0, o)))
            : ((s += pe.css(e, "padding" + Re[r], !0, o)),
              "padding" !== n &&
                (s += pe.css(e, "border" + Re[r] + "Width", !0, o)));
      return s;
    }
    function j(e, t, n) {
      ...
      return rt.test(r)
        ? r
        : ((i = s && (fe.boxSizingReliable() || r === e.style[t])),
          "auto" === r && (r = e["offset" + t[0].toUpperCase() + t.slice(1)]),
          (r = parseFloat(r) || 0) +
            P(e, t, n || (s ? "border" : "content"), i, o) +
            "px");
    }
      ...
      (w = t.support = {}),
          ...
          function (e) {
            ...
            return i !== I && 9 === i.nodeType && i.documentElement
              ? ((I = i),
                ...
                (H = []),
                ($ = []),
                (w.qsa = pe.test(I.querySelectorAll)) &&
                  (o(function (e) {
                  ...
                  ? function (e, t) {
                      ...
                      return (
                        ...
                        (!w.sortDetached && t.compareDocumentPosition(e) === n)
                          ? e === I || (e.ownerDocument === M && P(M, e))
                            ? -1
                            : t === I || (t.ownerDocument === M && P(M, t))
                            ? 1
                            : A
                            ? Z(A, e) - Z(A, t)
                            : 0
        ...
        (t.attr = function (e, t) {
          ...
          var n = T.attrHandle[t.toLowerCase()],
            i =
              n && V.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !L) : void 0;
          return void 0 !== i
            ? i
            : w.attributes || !L
            ? e.getAttribute(t)
    ...
    (pe.filter = function (e, t, n) {
      ...
      pe.fn.extend({
        ...
        is: function (e) {
          return !!r(
            this,
            "string" == typeof e && Ce.test(e) ? pe(e) : e || [],
            !1
          ).length;
        },
      });
      ...
      pe.fn.extend({
        data: function (e, t) {
          ...
          if (void 0 === e) {
            if (
              this.length &&
              ((o = He.get(r)), 1 === r.nodeType && !$e.get(r, "hasDataAttrs"))
            ) {
              for (n = s.length; n--; )
                s[n] &&
                  0 === (i = s[n].name).indexOf("data-") &&
                  ((i = pe.camelCase(i.slice(5))), p(r, i, o[i]));
    ...
    pe.extend({
      ...
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (s = y(a), r = y(e), i = 0, o = r.length; i < o; i++)
            D(r[i], s[i]);
        if (t)
          if (n)
            for (r = r || y(e), s = s || y(a), i = 0, o = r.length; i < o; i++)
              A(r[i], s[i]);
          else A(e, a);
        ...
        pe.cssHooks[t] = {
          ...
          set: function (e, n, i) {
            var o,
              ...
              s =
                i &&
                P(e, t, i, "border-box" === pe.css(e, "boxSizing", !1, r), r);
            return (
              s &&
                (o = Me.exec(n)) &&
                "px" !== (o[3] || "px") &&
      ...
      r = (function (e) {
        ...
        return (
          ...
          l.supportsTransitionEnd() &&
            (e.event.special[l.TRANSITION_END] = i()),
          l
        );
      })(jQuery),
      s =
              ...
              return (
                ...
                (t.prototype._removeElement = function (t) {
                  ...
                  return (
                    ...
                    r.supportsTransitionEnd() && e(t).hasClass(u.FADE)
                      ? void e(t)
        ...
        (function (e) {
                ...
                (t.prototype.toggle = function () {
                  ...
                  if (n) {
                    ...
                    if (i) {
                      ...
                      t &&
                        ((i.checked = !e(this._element).hasClass(l.ACTIVE)),
                        e(i).trigger("change")),
                        i.focus();
                    }
                  }
          ...
          e(document)
            .on(u.CLICK_DATA_API, c.DATA_TOGGLE_CARROT, function (t) {
              t.preventDefault();
              var n = t.target;
            ...
            m = (function () {
              ...
              return (
                ...
                (l.prototype._getConfig = function (n) {
                  return (
                    (n = e.extend({}, u, n)), r.typeCheckConfig(t, n, d), n
                  );
                }),
                ...
                (l.prototype._getItemByDirection = function (e, t) {
                  ...
                  if (((i && 0 === o) || (n && o === r)) && !this._config.wrap)
                    return t;
                  var s =
                    (o + (e === f.PREVIOUS ? -1 : 1)) % this._items.length;
                  return -1 === s
                ...
                (l.prototype._slide = function (t, n) {
                  ...
                  if (
                    (t === f.NEXT
                      ? ((l = p.LEFT), (c = p.NEXT), (u = f.LEFT))
                      : ((l = p.RIGHT), (c = p.PREV), (u = f.RIGHT)),
                    ...
                    r.supportsTransitionEnd() &&
                    e(this._element).hasClass(p.SLIDE)
                      ? (e(s).addClass(c),
                        r.reflow(s),
                        e(o).addClass(l),
                        e(s).addClass(l),
                ...
                (l._jQueryInterface = function (t) {
                  return this.each(function () {
                    ...
                    if (
                      (n || ((n = new l(this, o)), e(this).data(s, n)),
                      "number" == typeof t)
                    )
                      n.to(t);
              ...
              return (
                ...
                (a.prototype.show = function () {
                  ...
                  if (!e(this._element).hasClass(f.SHOW)) {
                    ...
                    if (
                      (this._parent &&
                        ((n = e.makeArray(e(this._parent).find(p.ACTIVES)))
                          .length ||
                          (n = null)),
                      ...
                      if (
                        (e(this._element).trigger(o), !o.isDefaultPrevented())
                      ) {
                        n &&
                          (a._jQueryInterface.call(e(n), "hide"),
                          i || e(n).data(s, null));
                ...
                (a.prototype._getDimension = function () {
                  return e(this._element).hasClass(h.WIDTH)
                    ? h.WIDTH
                    : h.HEIGHT;
                }),
        ...
        (function (e) {
              ...
              return (
                ...
                (t._clearMenus = function (n) {
                  if (!n || 3 !== n.which) {
                    ...
                    for (
                      var o = e.makeArray(e(d.DATA_TOGGLE)), r = 0;
                      r < o.length;
                      r++
                    ) {
          ...
          e(document)
            .on(c.KEYDOWN_DATA_API, d.DATA_TOGGLE, f._dataApiKeydownHandler)
            .on(c.KEYDOWN_DATA_API, d.ROLE_MENU, f._dataApiKeydownHandler)
            .on(c.KEYDOWN_DATA_API, d.ROLE_LISTBOX, f._dataApiKeydownHandler)
            .on(c.CLICK_DATA_API + " " + c.FOCUSIN_DATA_API, f._clearMenus)
            .on(c.CLICK_DATA_API, d.DATA_TOGGLE, f.prototype.toggle)
            ...
            p = (function () {
              ...
              return (
                ...
                (l.prototype.show = function (t) {
                  ...
                  r.supportsTransitionEnd() &&
                    e(this._element).hasClass(f.FADE) &&
                ...
                (l.prototype._getConfig = function (n) {
                  return (
                    (n = e.extend({}, c, n)), r.typeCheckConfig(t, n, u), n
                  );
                }),
                ...
                (l.prototype._setScrollbar = function () {
                  var t = parseInt(
                    e(h.FIXED_CONTENT).css("padding-right") || 0,
                    10
                  );
                ...
                (l._jQueryInterface = function (t, n) {
                  return this.each(function () {
                    ...
                    if (
                      (o || ((o = new l(this, r)), e(this).data(s, o)),
                      "string" == typeof t)
                    ) {
                      if (void 0 === o[t])
                        throw new Error('No method named "' + t + '"');
              ...
              return (
                ...
                (l.prototype._getConfig = function (n) {
                  if ("string" != typeof (n = e.extend({}, c, n)).target) {
                    ...
                    i || ((i = r.getUID(t)), e(n.target).attr("id", i)),
                      (n.target = "#" + i);
                  }
              ...
              return (
                (t.prototype.show = function () {
                  ...
                  if (
                    ...
                    o &&
                      ((i = e.makeArray(e(o).find(u.ACTIVE))),
                      (i = i[i.length - 1]));
                ...
                (t.prototype._activate = function (t, n, i) {
                  var o = this,
                    ...
                    a =
                      i &&
                      r.supportsTransitionEnd() &&
                      ((s && e(s).hasClass(c.FADE)) ||
                        Boolean(e(n).find(u.FADE_CHILD)[0])),
                    l = function () {
                      return o._transitionComplete(t, s, a, i);
                    };
                  s && a
                    ? e(s).one(r.TRANSITION_END, l).emulateTransitionEnd(150)
                    : l(),
                ...
                (t.prototype._transitionComplete = function (t, n, i, o) {
                  ...
                  if (
                    ...
                    i
                      ? (r.reflow(t), e(t).addClass(c.SHOW))
                      : e(t).removeClass(c.FADE),
              ...
              return (
                ...
                (l.prototype._enter = function (t, n) {
                  ...
                  return (
                    ...
                    t &&
                      (n._activeTrigger[
                        "focusin" === t.type ? v.FOCUS : v.HOVER
                      ] = !0),
                    e(n.getTipElement()).hasClass(p.SHOW) ||
                    n._hoverState === f.SHOW
                      ? void (n._hoverState = f.SHOW)
                ...
                (l.prototype._leave = function (t, n) {
                  ...
                  if (
                    ...
                    t &&
                      (n._activeTrigger[
                        "focusout" === t.type ? v.FOCUS : v.HOVER
                      ] = !1),
            ...
            (u._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  ...
                  (t || ((t = new u(this, n)), r(this).data(l, t)),
                  "string" == typeof e)
                ) {
                  if (void 0 === t[e])
    ...
    e.fn.countdown = function (t, n) {
      function i() {
        (eventDate = Date.parse(o.date) / 1e3),
          ...
          eventDate <= currentDate && (n.call(this), clearInterval(interval)),
          ...
          isNaN(eventDate)
            ? (alert(
                "Invalid date. Here's an example: 12 Tuesday 2016 17:30:00"
              ),
        ...
        prototype: {
          ...
          formatAndAdd: function (t, n) {
            ...
            "function" == typeof i
              ...
              : o.test(i) &&
                (i = e.validator.format(i.replace(o, "{$1}"), n.parameters)),
              this.errorList.push({
                message: i,
                element: t,
                method: n.method,
          ...
          showLabel: function (t, n) {
            ...
            s.length
              ...
              : ((i = s =
                ...
                s.is("label")
                  ? s.attr("for", a)
                  : 0 === s.parents("label[for='" + a + "']").length &&
                    ((r = s.attr("id").replace(/(:|\.|\[|\])/g, "\\$1")),
                    l
                      ? l.match(new RegExp("\\b" + r + "\\b")) || (l += " " + r)
                      : (l = r),
                      ...
                      !0,
                      {
                        ...
                        success: function (i) {
                          var r,
                            ...
                            l,
                            c = !0 === i || "true" === i;
                          (o.settings.messages[n.name].remote =
                            s.originalMessage),
                            c
                              ? ((l = o.formSubmitted),
                                o.prepareElement(n),
          ...
          $.ajax({
            ...
            success: function (i) {
              "success" == i
                ? r
                  ? (e[0].reset(),
                    n
                      .fadeIn("slow")
                      .html(
                        '<div class="mt-3 help-block text-success">' +
                          s +
                          "</div>"
                      )
                      .delay(3e3)
                ...
                : (n
                    .fadeIn("slow")
                    .html(
                      '<div class="mt-3 help-block text-danger">' + a + "</div>"
                    )
                    .delay(3e3)
                    .fadeOut("slow"),
            ...
            error: function (e) {
              n
                .fadeIn("slow")
                .html(
                  '<div class="mt-3 help-block text-danger"> Cannot access Server</div>'
                )
                .delay(3e3)
                .fadeOut("slow"),
                t.attr("disabled", !1),
                window.console &&
                  console.error(
                    "JS Error: Please make sure you are running on a PHP Server"
                  );
            },
          }),
          !1
              ...
              $.ajax({
                    ...
                    "success" == e
                      ? o
                        ? n
                            .fadeIn("slow")
                            .html(
                              '<p class="mt-3 help-block text-success">' +
                                r +
                                "</p>"
                            )
                            .delay(3e3)
                      ...
                      : (n
                          .fadeIn("slow")
                          .html(
                            '<p class="mt-3 help-block text-danger">' +
                              s +
                              "</p>"
                          )
                          .delay(3e3)
                ...
                error: function (e) {
                  n
                    .fadeIn("slow")
                    .html(
                      '<p class="mt-3 help-block text-danger"> Sorry. Cannot access the PHP Server</p>'
                    )
                    .delay(3e3)
                    .fadeOut("slow"),
                    t.attr("disabled", !1);
...
$(function () {
  ...
  $(".hamburger").on("click", function () {
    $("body").toggleClass("sidebar-open"),
      setTimeout(function () {
        $scrollable
          .find(".aos-init:not(.aos-animate):in-viewport")
